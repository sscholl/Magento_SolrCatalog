...
class SScholl_SolrCatalog_Adminhtml_Catalog_Product_SetController extends Mage_Adminhtml_Controller_Action
{
    public function indexAction()
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('sschollsolrcatalog/adminhtml_catalog_product_attribute_set_toolbar_main'));
        $this->_addContent($this->getLayout()->createBlock('sschollsolrcatalog/adminhtml_catalog_product_attribute_set_grid'));
    ...
    public function editAction()
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('sschollsolrcatalog/adminhtml_catalog_product_attribute_set_main'));
    ...
    public function setGridAction()
    {
        ...
        $this->getResponse()->setBody(
            $this->getLayout()
                ->createBlock('sschollsolrcatalog/adminhtml_catalog_product_attribute_set_grid')
                ->toHtml());
    }
    ...
    public function addAction()
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('sschollsolrcatalog/adminhtml_catalog_product_attribute_set_toolbar_add'));
