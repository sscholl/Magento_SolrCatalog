...
class SScholl_SolrCatalog_Adminhtml_Catalog_Product_AttributeController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        $this->_initAction()
            ->_addContent($this->getLayout()->createBlock('sschollsolrcatalog/adminhtml_catalog_product_attribute'))
            ->renderLayout();
    }
