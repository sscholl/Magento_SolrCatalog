 ...
 */
class SScholl_SolrCatalog_Adminhtml_Catalog_Product_Action_AttributeController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        return Mage::helper('sschollsolrcatalog/adminhtml_catalog_product_edit_action_attribute');
    }
