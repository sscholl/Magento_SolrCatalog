...
class SScholl_SolrCatalog_Adminhtml_Catalog_ProductController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    protected function _initProduct()
    {
        ...
        if ($this->getRequest()->getParam('popup')
            ...
            $configProduct = Mage::getModel('sschollsolrcatalog/product')
                ->setStoreId(0)
    ...
    {
        return $this->getLayout()->createBlock('sschollsolrcatalog/adminhtml_catalog_product_edit_tab_ajax_serializer')
    ...
    public function gridOnlyAction()
    {
        ...
        $this->getResponse()->setBody(
            $this->getLayout()
                ->createBlock('sschollsolrcatalog/adminhtml_catalog_product_edit_tab_' . $this->getRequest()->getParam('gridOnlyBlock'))
                ->toHtml()
        );
    }
...
//            }
    ...
    public function categoriesJsonAction()
    {
        ...
        $this->getResponse()->setBody(
            $this->getLayout()->createBlock('sschollsolrcatalog/adminhtml_catalog_product_edit_tab_categories')
            ...
            try {
                ...
                if (isset($data['copy_to_stores'])) {
                    foreach ($data['copy_to_stores'] as $storeTo=>$storeFrom) {
                        $newProduct = Mage::getModel('sschollsolrcatalog/product')
     ...
     * @return SScholl_SolrCatalog_Adminhtml_Catalog_ProductController
     */
    ...
    public function addAttributeAction()
    {
        ...
        $this->_initProduct();
        $this->_addContent(
            $this->getLayout()->createBlock('sschollsolrcatalog/adminhtml_catalog_product_attribute_new_product_created')
        );
        $this->renderLayout();
    }
    ...
    public function createdAction()
    {
        ...
        $this->loadLayout('popup');
        $this->_addContent(
            $this->getLayout()->createBlock('sschollsolrcatalog/adminhtml_catalog_product_created')
        );
        $this->renderLayout();
    }
...
//            }
    ...
    public function showUpdateResultAction()
    {
        ...
        if ($session->hasCompositeProductResult() && $session->getCompositeProductResult() instanceof Varien_Object){
            ...
            $helper = Mage::helper('sschollsolrcatalog/adminhtml_catalog_product_composite');
