 ...
 */
class SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Widget_Chooser extends Mage_Adminhtml_Block_Widget_Grid
{
     ...
     * @return SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Widget_Chooser
     */
