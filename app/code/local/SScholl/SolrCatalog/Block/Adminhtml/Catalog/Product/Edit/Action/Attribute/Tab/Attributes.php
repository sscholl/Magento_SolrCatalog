 ...
 */
class SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Edit_Action_Attribute_Tab_Attributes
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    {
        return $this->helper('sschollsolrcatalog/adminhtml_catalog_product_edit_action_attribute')->getAttributes()->getItems();
    }
