 ...
 */
class SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Attribute_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('main', array(
            ...
            'content'   => $this->getLayout()->createBlock('sschollsolrcatalog/adminhtml_catalog_product_attribute_edit_tab_main')->toHtml(),
            'active'    => true
        ));
        ...
        $this->addTab('labels', array(
            ...
            'content'   => $this->getLayout()->createBlock('sschollsolrcatalog/adminhtml_catalog_product_attribute_edit_tab_options')->toHtml(),
        ));
