 ...
 */
class SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    protected $_attributeTabBlock = 'sschollsolrcatalog/adminhtml_catalog_product_edit_tab_attributes';
    ...
    protected function _prepareLayout()
    {
        ...
        if ($setId) {
            ...
            foreach ($groupCollection as $group) {
	        	...
	        	if (in_array($group->getAttributeGroupName(), $disabledTabs)) continue;
            ...
            /*if (Mage::helper('core')->isModuleEnabled('Mage_CatalogInventory')) {
                $this->addTab('inventory', array(
                    ...
                    'content'   => $this->_translateHtml($this->getLayout()
                        ->createBlock('sschollsolrcatalog/adminhtml_catalog_product_edit_tab_inventory')->toHtml()),
                ));
            }*/
            ...
            if (!Mage::app()->isSingleStoreMode()) {
                $this->addTab('websites', array(
                    ...
                    'content'   => $this->_translateHtml($this->getLayout()
                        ->createBlock('sschollsolrcatalog/adminhtml_catalog_product_edit_tab_websites')->toHtml()),
                ));
            }*/
...
/*
            if (($alertPriceAllow || $alertStockAllow) && !$product->isGrouped()) {
                $this->addTab('productalert', array(
                    ...
                    'content'   => $this->_translateHtml($this->getLayout()
                        ->createBlock('sschollsolrcatalog/adminhtml_catalog_product_edit_tab_alerts', 'admin.alerts.products')->toHtml())
                ));
            }
*/
...
//             }
             ...
             * @see SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Edit_Tabs_Configurable
...
//             }
            ...
            $this->addTab('set', array(
                ...
                'content'   => $this->_translateHtml($this->getLayout()
                    ->createBlock('sschollsolrcatalog/adminhtml_catalog_product_edit_tab_settings')->toHtml()),
                'active'    => true
            ));
        }
