 ...
 */
class SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Edit_Action_Attribute extends Mage_Adminhtml_Block_Widget
{
    ...
    {
        return $this->helper('sschollsolrcatalog/adminhtml_catalog_product_edit_action_attribute');
    }
    ...
    {
        return $this->getUrl('*/*/save', array('store'=>Mage::helper('sschollsolrcatalog/adminhtml_catalog_product_edit_action_attribute')->getSelectedStoreId()));
    }
