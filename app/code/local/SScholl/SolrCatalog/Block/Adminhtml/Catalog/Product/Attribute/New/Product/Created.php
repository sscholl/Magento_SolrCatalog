 ...
 */
class SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Attribute_New_Product_Created extends Mage_Adminhtml_Block_Widget
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild(
            'attributes',
            $this->getLayout()->createBlock('sschollsolrcatalog/adminhtml_catalog_product_attribute_new_product_attributes')
...
} // Class SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Attribute_New_Product_Created End
