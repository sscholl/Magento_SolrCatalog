 ...
 */
class SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Edit_Tab_Super_Config extends Mage_Adminhtml_Block_Widget
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
     ...
     * Prepare Layout data
     *
     * @return SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Edit_Tab_Super_Config
     */
    protected function _prepareLayout()
    {
        $this->setChild('grid',
            $this->getLayout()->createBlock('sschollsolrcatalog/adminhtml_catalog_product_edit_tab_super_config_grid',
        ...
        if ($this->_getProduct()->getId()) {
            $this->setChild('simple',
                $this->getLayout()->createBlock('sschollsolrcatalog/adminhtml_catalog_product_edit_tab_super_config_simple',
