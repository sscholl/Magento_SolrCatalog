...
class SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Edit_Tab_Options_Type_Select extends
    SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Edit_Tab_Options_Type_Abstract
{
    /**
     * Class constructor
     */
