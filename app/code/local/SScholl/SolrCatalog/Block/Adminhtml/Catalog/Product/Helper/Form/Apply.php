 ...
 */
class SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Helper_Form_Apply extends Varien_Data_Form_Element_Multiselect
{
     ...
     * @return SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Helper_Form_Apply
     */
