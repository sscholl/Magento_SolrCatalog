 ...
 */
class SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Edit_Tab_Super_Config_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
     ...
     * Prepare collection
     *
     * @return SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Edit_Tab_Super_Config_Grid
     */
    ...
    protected function _prepareColumns()
    {
        ...
        if (!$this->isReadonly()) {
            $this->addColumn('in_products', array(
                ...
                'align'     => 'center',
                'index'     => 'entity_id',
                'renderer'  => 'sschollsolrcatalog/adminhtml_catalog_product_edit_tab_super_config_grid_renderer_checkbox',
        ...
        $this->addColumn('is_saleable', array(
            ...
            'renderer'  => 'sschollsolrcatalog/adminhtml_catalog_product_edit_tab_super_config_grid_renderer_inventory',
            'filter'    => 'sschollsolrcatalog/adminhtml_catalog_product_edit_tab_super_config_grid_filter_inventory',
            'index'     => 'is_saleable'
        ));
