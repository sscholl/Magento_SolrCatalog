 ...
 */
class SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Attribute_Edit_Tab_Main extends Mage_Eav_Block_Adminhtml_Attribute_Edit_Main_Abstract
{
    /**
     * Adding product form elements for editing attribute
     *
     * @return SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Attribute_Edit_Tab_Main
     */
    ...
    {
        return array(
            'apply'         => Mage::getConfig()->getBlockClassName('sschollsolrcatalog/adminhtml_catalog_product_helper_form_apply'),
        );
    }
}
