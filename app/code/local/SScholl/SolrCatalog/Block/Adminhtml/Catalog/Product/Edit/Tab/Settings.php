 ...
 */
class SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Edit_Tab_Settings extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('product_type', 'select', array(
            ...
            'name'  => 'type',
            'value' => '',
        	'values'=> array(Mage_Catalog_Model_Product_Type::TYPE_SIMPLE => $options[Mage_Catalog_Model_Product_Type::TYPE_SIMPLE]),
