 ...
 */
class SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Edit extends Mage_Adminhtml_Block_Widget
{
    ...
    {
    	/* remove comment if duplicate button is needed */
        //return $this->getChildHtml('duplicate_button');
    }

    public function getValidationUrl()
    {
    	/* remove comment if validate button is needed */
