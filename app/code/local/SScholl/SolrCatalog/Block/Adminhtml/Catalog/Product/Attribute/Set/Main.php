 ...
 */
class SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Attribute_Set_Main extends Mage_Adminhtml_Block_Template
{
    /**
     * Initialize template
     *
     ...
     *
     * @return SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Attribute_Set_Main
     */
    protected function _prepareLayout()
    {
        ...
        $this->setChild('group_tree',
            $this->getLayout()->createBlock('sschollsolrcatalog/adminhtml_catalog_product_attribute_set_main_tree_group')
        );

        $this->setChild('edit_set_form',
            $this->getLayout()->createBlock('sschollsolrcatalog/adminhtml_catalog_product_attribute_set_main_formset')
        );
    ...
    public function getGroupTreeJson()
    {
        ...
        foreach ($groups as $node) {
        	$disabledTabs = array ('Images' ,'Recurring Profile', 'Design', 'Gift Options');
        	if (in_array($node->getAttributeGroupName(), $disabledTabs)) continue;
            $item = array();
