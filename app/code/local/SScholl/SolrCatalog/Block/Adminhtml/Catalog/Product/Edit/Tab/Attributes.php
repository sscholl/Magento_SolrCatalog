 ...
 */
class SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Edit_Tab_Attributes extends Mage_Adminhtml_Block_Catalog_Form
{
    /**
        ...
        if ($group) {
            ...
            if ($tierPrice) {
                $tierPrice->setRenderer(
                    $this->getLayout()->createBlock('sschollsolrcatalog/adminhtml_catalog_product_edit_tab_price_tier')
                );
            }
            ...
            if ($groupPrice) {
                $groupPrice->setRenderer(
                    $this->getLayout()->createBlock('sschollsolrcatalog/adminhtml_catalog_product_edit_tab_price_group')
                );
            }
            ...
            if ($recurringProfile) {
                $recurringProfile->setRenderer(
                    $this->getLayout()->createBlock('sschollsolrcatalog/adminhtml_catalog_product_edit_tab_price_recurring')
                );
            }
            ...
            if (!$form->getElement('media_gallery')
                ...
                $headerBar = $this->getLayout()->createBlock('sschollsolrcatalog/adminhtml_catalog_product_edit_tab_attributes_create');
    ...
    {
        $result = array(
            'price'    => Mage::getConfig()->getBlockClassName('sschollsolrcatalog/adminhtml_catalog_product_helper_form_price'),
            'weight'   => Mage::getConfig()->getBlockClassName('sschollsolrcatalog/adminhtml_catalog_product_helper_form_weight'),
            'gallery'  => Mage::getConfig()->getBlockClassName('sschollsolrcatalog/adminhtml_catalog_product_helper_form_gallery'),
            'image'    => Mage::getConfig()->getBlockClassName('sschollsolrcatalog/adminhtml_catalog_product_helper_form_image'),
            'boolean'  => Mage::getConfig()->getBlockClassName('sschollsolrcatalog/adminhtml_catalog_product_helper_form_boolean'),
