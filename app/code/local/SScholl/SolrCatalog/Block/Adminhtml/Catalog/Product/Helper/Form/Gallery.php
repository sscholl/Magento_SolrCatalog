 ...
 */
class SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Helper_Form_Gallery extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getContentHtml()
    {
        ...
        /* @var $content SScholl_SolrCatalog_Block_Adminhtml_Catalog_Product_Helper_Form_Gallery_Content */
        $content = Mage::getSingleton('core/layout')
            ->createBlock('sschollsolrcatalog/adminhtml_catalog_product_helper_form_gallery_content');
